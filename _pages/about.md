...
I also write at the [TransferLab blog](https://transferlab.ai/authors/jan-teusen/) on applied probabilistic ML topics. You'll find code on [GitHub](https://github.com/janfb), papers on [Google Scholar](https://scholar.google.de/citations?user=wsE4N68AAAAJ&hl=en), and the occasional thread on [X](https://x.com/janfiete).
